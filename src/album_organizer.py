...
class album_organizer:
    ...
    def organize_album_dir(self, fn, folder_path):
        try:
            ...
            print('   |-- [1-2] Move MP3/file to previous folder, and remove empty folder')
    ...
    def raname_album_dir(self, fn, folder_path):
        print('   |-- [2-1] Rename the album folder')
        fn_path = f'{folder_path}\\{fn}'
        fn_new = fn
        ...
        if fn_new != fn:
            ...
            os.rename(fn_path, f'{folder_path}\\{fn_new}')
